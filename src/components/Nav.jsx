  ...
  return (
    <div className="sticky top-0 z-50 border-b-2 shadow-xl">
      ...
      <div className="flex justify-between bg-white">
        <div className="w-24 flex justify-center items-center bg-white text-black rounded-r-full text-lg font-arabic">
          اَللہُ اَکَبْرَ
        </div>
        <div className="w-40 flex justify-center items-center p-1">
          <Logo />
        </div>
        <div className="w-24 flex flex-col justify-around items-end px-5 py-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
